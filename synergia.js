...
// 2️⃣ POST /api/bookings → Create a new booking
app.post('/api/bookings', (req, res) => {
  ...
  if (!event) {
    return res.status(400).json({ message: 'Invalid event ID. Please create the event first.' });
  }
...
// 4️⃣ PUT /api/bookings/:id → Update booking participant name
...
// 5️⃣ DELETE /api/bookings/:id → Cancel a booking
