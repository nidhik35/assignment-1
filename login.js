...
async function sendEmail(title,content){
    let transporter=nodemailer.createTransport({
        service:"gmail",
        auth:{
            user:"nidhi.k.devadiga12@gmail.com",
            pass:password
        }
    })
    const mailOptions={
        from:'"Skill Lab" <nidhi.k.devadiga12@gmail.com>',
        to:'shravya9106@gmail.com',
        subject: title,
        text: content,
...
app.post('/login',(request,response)=>{
    ...
    if(email=='nidhi.k.devadiga12@gmail.com' && password=="pass@123"){
